                    ...
                    {user ? (
                        <div>
                            <div className="flex flex-col md:flex-row w-full max-w-4xl gap-8">
                                <Image
                                    src={profile?.avatar_url || "https://i.pravatar.cc/150?u=a04258a2462d826712d"}
                            ...
                            <div className="inline-block max-w-xl text-center justify-center mt-8">
                                ...
                                <div className="text-lg md:text-xl text-gray-500 font-medium mb-4">
                                    ...
                                    Id nam omnis autem vel earum! Perferendis quod dignissimos ea error in rem libero eligendi vero nemo voluptate autem, laboriosam iste labore.
                                </div>
                            </div>
                        </div>
                    ) : (
